...
namespace NatSuite.Devices.Internal {
    ...
    public static class Bridge {
        ...
        #region --Delegates--
        public delegate void PixelBufferHandler (IntPtr context, IntPtr pixelBuffer, int width, int height, long timestamp);
        public delegate void SampleBufferHandler (IntPtr context, IntPtr sampleBuffer, int sampleCount, long timestamp);
        #endregion
        ...
        [DllImport(Assembly, EntryPoint = @"NDSetEchoCancellation")]
        ...
        public static extern bool StartRunning (this IntPtr device, SampleBufferHandler callback, IntPtr context);
        #endregion
        ...
        public static extern void StartRunning (this IntPtr device, PixelBufferHandler handler, IntPtr context);
        [DllImport(Assembly, EntryPoint = @"NDCapturePhoto")]
        public static extern void CapturePhoto (this IntPtr device, PixelBufferHandler handler, IntPtr context);
        #endregion
    }
}